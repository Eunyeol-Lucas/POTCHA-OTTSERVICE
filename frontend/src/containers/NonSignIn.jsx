...
import OttServiceRateChart from "../components/OttServiceRateChart";
import OttServiceRateData from "../components/OttServiceRateData";
import MovieCustomerRateChart from "../components/MovieCustomerRateChart";
import MovieCustomerRateData from "../components/MovieCustomerRateData";
import NetflixOriginalMovieChart from "../components/NetflixOriginalMovieChart";
import NetflixOriginalMovieData from "../components/NetflixOriginalMovieData";
                    ...
                    <div className="temp">
                      ...
                      >
                        <div className="sectionThree slideOne Title">
                          <Title
                            style={{ marginBottom: "40px", fontSize: "50px" }}
                          >
